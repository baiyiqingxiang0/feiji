...
player_image = pygame.image.load(path_+'planeNormal_2.png')
player_rect = player_image.get_rect()
player_pos = [200, 600]
player = Player(player_image, player_rect, player_pos)
...
enemyPlane_img = pygame.image.load(path_+'enemyPlane2.jpg')
enemyPlane_rect = enemyPlane_img.get_rect()
enemy_down_img = pygame.image.load(path_+'enemy_2.jpg')
...
while running:
    ...
    if enemy_frequency % 750 == 0:
        ...
        enemyPlane = Enemy(enemyPlane_img,enemyPlane_img,enemyPlane_pos,True)
    ...
    for enemy in enemies:
        ...
        if pygame.sprite.collide_mask(enemy,player):
            ...
            screen.blit(player_down_img, player_rect)
            break
    ...
    for enemy_down in enemies_down:
        ...
        if enemy_down.down_index > 7:
            ...
            score += 100
            continue
        screen.blit(enemy_down_img,enemy_down.rect)
